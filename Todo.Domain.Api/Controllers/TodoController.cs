...
namespace Todo.Domain.Api.Controllers
{
    ...
    public class TodoController : ControllerBase
    {
        ...
        {
            return repository.GetAll("danielsr");
        }
        ...
        {
            // var user = User.Claims.FirstOrDefault(x => x.Type == "user_id")
            return repository.GetAllDone("danielsr");
        }
        ...
        {
            // var user = User.Claims.FirstOrDefault(x => x.Type == "user_id")
            return repository.GetAllUndone("danielsr");
        }
        ...
        {
           return repository.GetByPeriod("danielsr", DateTime.Now.Date, true);
        }
        ...
        {
           return repository.GetByPeriod("danielsr", DateTime.Now.Date, false);
        }
        ...
        {
           return repository.GetByPeriod("danielsr", DateTime.Now.Date.AddDays(1), true);
        }
        ...
        {
           return repository.GetByPeriod("danielsr", DateTime.Now.Date.AddDays(1), false);
        }
